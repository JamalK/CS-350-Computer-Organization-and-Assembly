...
int main() 
{
    ...
    unsigned short int ch4 = (unsigned short int) 0xff;
    ...
    unsigned int ch6 = (unsigned int) 0xff;
    ...
    unsigned long int ch8 = (unsigned long int) 0xff;
