...
int instruction_cycle(int mem[], int regs[], int PC);
int getcount(int mem[], int PC);
int getfirst(int mem[], int PC, int intCount);
int getsecond(int mem[], int PC, int intCount);
int getrest(int mem[], int PC, int intCount);
...
int main(void)
{
	...
	do
    {
        ...
        numCountRef = getcount(mem, PC);
        firstNumRef = getfirst(mem, PC, numCountRef);
        secondNumRef = getsecond(mem, PC, numCountRef);
        intRestRef = getrest(mem, PC, numCountRef);
...
int instruction_cycle(int mem[], int regs[], int PC)
{
    ...
    intCount = getcount(mem, PC);
    firstNum = getfirst(mem, PC, intCount);
    secondNum = getsecond(mem, PC, intCount);
    intRest = getrest(mem, PC, intCount);
    ...
    if (firstNum != 0)
        printf("At %02d instr %d %d %02d: ", PC, firstNum, secondNum, intRest);
